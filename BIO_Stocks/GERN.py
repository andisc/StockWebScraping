...
def main(id_control):
    ...
    try:
        url = 'https://ir.geron.com/investors/press-releases/' 
        ...
        #print(soup)
        table_panel = soup.find('div', attrs={'class':'module_container module_container--widget'})
        table = table_panel.find('table', attrs={'class':'table'})
        #print(table)
