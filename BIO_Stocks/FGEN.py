...
def main(id_control):
    try:
        url = 'https://investor.fibrogen.com/news-releases' 
        ...
        article_date = FIRST_ARTICLE.find('span', attrs={'class':'nir-widget--news--date-time'})
        article_desc = FIRST_ARTICLE.find('div', attrs={'class':'content nir-widget--news--headline'})
