...
def main(id_control):
    try:
        url = 'https://www.4dmoleculartherapeutics.com/investors-media/press-releases/' 
        ...
        #print(soup)
        articles = soup.findAll('div', attrs={'class':'news-item row no-margin'})
        
        # get first article
        FIRST_ARTICLE = articles[0]

        all_a4 = FIRST_ARTICLE.findAll('h4')
        article_date = all_a4[0]
        article_desc = all_a4[1]
