...
def main(id_control):
    try:
        url = 'https://ir.covetrus.com/index.php/investors/press-releases' 
        ...
        article_date = FIRST_ARTICLE.find('div', attrs={'class':'large-3 columns ndq-news-date nir-widget--field'})
