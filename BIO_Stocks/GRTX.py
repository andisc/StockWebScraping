...
def main(id_control):
    ...
    try:
        url = 'https://investors.galeratx.com/news-releases/' 
        ...
        table = soup.find('table', attrs={'class':'nirtable views-table views-view-table cols-3 collapse-table news-table-v2 jq-headers'})
        #print(table)
