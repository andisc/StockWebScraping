...
def main(id_control):
    try:
        url = 'https://investor.meipharma.com' 
        ...
        #print(soup)
        articles_panel = soup.find('div', attrs={'class':'wd_news_releases-teaser'})
        articles = articles_panel.findAll('div', attrs={'class':'item'})
        
        # get first article
        FIRST_ARTICLE = articles[0]

        article_date = FIRST_ARTICLE.find('div', attrs={'class':'item_date'})
        article_desc = FIRST_ARTICLE.find('div', attrs={'class':'item_name'})
