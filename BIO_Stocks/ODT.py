...
def main(id_control):
    try:
        url = 'https://ir.odonate.com/press-releases' 
        ...
        #print(soup)
        articles_panel = soup.find('ul', attrs={'class':'NewsList_articles__3nl3e'})
        articles = articles_panel.findAll('li', attrs={'class':'NewsListItem_article__2V6IV'})
        
        # get first article
        FIRST_ARTICLE = articles[0]

        article_date = FIRST_ARTICLE.find('span', attrs={'class':'NewsListItem_articleDate__2p2dD'})
