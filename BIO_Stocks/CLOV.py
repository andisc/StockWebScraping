...
def main(id_control):
    try:
        url = 'https://www.cloverhealth.com/en/about-us/press' 
        ...
        #print(soup)
        articles_panel = soup.find('div', attrs={'class':'row press-release-highlight'})
        articles = articles_panel.findAll('div', attrs={'class':'col-md-4'})
        
        
        # get first article
        FIRST_ARTICLE = articles[0]

        article_date = FIRST_ARTICLE.find('span', attrs={'class':'press-release-highlight__date'})
