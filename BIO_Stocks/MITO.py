...
def main(id_control):
    try:
        url = 'https://investor.stealthbt.com/websites/stealthbio/English/5000/news.html' 
        ...
        #print(soup)
        articles = soup.findAll('div', attrs={'class':'qtmanews__content--new allnews-list'})
        
        # get first article
        FIRST_ARTICLE = articles[0]

        article_date = FIRST_ARTICLE.find('span', attrs={'class':'qtmanews__item-child qtmanews__item--date news__date'})
        article_desc = FIRST_ARTICLE.find('h3', attrs={'class':'qtmanews__item-child qtmanews__item--title'})
