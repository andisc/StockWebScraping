...
def main(id_control):
    try:
        url = 'https://investor.adagene.com/news-events/news-releases' 
        req = Request(
            url=url, 
        ...
        article_date = FIRST_ARTICLE.find('div', attrs={'class':'nir-widget--field nir-widget--news--date-time idm-mb-2'})
