...
def main(id_control):
    try:
        url = 'https://www.vallon-pharma.com/news/' 
        ...
        #print(soup)
        articles = soup.find('div', attrs={'class':'wpb_raw_code wpb_content_element wpb_raw_html'})
        
        # get first article
        FIRST_ARTICLE = articles

        all_date = FIRST_ARTICLE.findAll('span', attrs={'class':'small'})
