...
def main(id_control):
    try:
        url = 'https://www.invobioscience.com/investors/press-releases/' 
        ...
        #print(soup)
        articles_panel = soup.find('section', attrs={'class':'items-grid wf-container'})
        articles = articles_panel.findAll('div', attrs={'class':'wf-cell wf-1'})
