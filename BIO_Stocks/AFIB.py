...
def main(id_control):
    try:
        url = 'https://ir.acutusmedical.com/news-and-events/press-releases' 
        ...
        article_day = FIRST_ARTICLE.find('span', attrs={'class':'press-date'})
        article_month_year = FIRST_ARTICLE.find('span', attrs={'class':'press-year'})
        article_date = (article_day.text + ' ' + article_month_year.text)
