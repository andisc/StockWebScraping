...
def main(id_control):
    try:
        url = 'http://ir.scpharma.com/news-releases/' 
        ...
        #print(soup)
        articles = soup.findAll('div', attrs={'class':'ndaq-article'})
        
        # get first article
        FIRST_ARTICLE = articles[0]

        article_date = FIRST_ARTICLE.find('div', attrs={'class':'ndaq-article-date'})
        article_desc = FIRST_ARTICLE.find('div', attrs={'class':'ndaq-article-title'})
