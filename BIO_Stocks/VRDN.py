...
def main(id_control):
    try:
        url = 'http://investors.miragen.com/press-releases/default.aspx' 
        ...
        #print(soup)
        articles_panel = soup.find('div', attrs={'class':'newsPanelResults'})
        articles = articles_panel.findAll('div', attrs={'class':'irwTableRowItem irwLoadingdata'})
