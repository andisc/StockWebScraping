...
def main(id_control):
    try:
        url = 'https://investors.metacrine.com/news-releases/' 
        ...
        article_desc = FIRST_ARTICLE.find('a', attrs={'class':'nir-widget--accordion-toggle nir-widget--news--accordion-toggle'})
        article_url = FIRST_ARTICLE.find('div', attrs={'class':'nir-widgets-file-link'})
