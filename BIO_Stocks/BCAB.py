...
def main(id_control):
    try:
        url = 'https://www.bioatla.com/news/' 
        ...
        #print(soup)
        articles = soup.findAll('div', attrs={'class':'item-inner'})
        
        # get first article
        FIRST_ARTICLE = articles[0]

        article_date = FIRST_ARTICLE.find('time', attrs={'class':'item-date'})
        article_desc = FIRST_ARTICLE.find('h4', attrs={'class':'item-title'})
