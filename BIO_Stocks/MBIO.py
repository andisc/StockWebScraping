...
def main(id_control):
    try:
        url = 'https://ir.mustangbio.com/News/default.aspx' 
        ...
        #print(soup)
        articles_panel = soup.find('div', attrs={'id':'newsPanelResults'})
        articles = articles_panel.findAll('div', attrs={'class':'irwTableRowItem'})
