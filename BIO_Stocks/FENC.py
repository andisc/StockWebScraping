...
def main(id_control):
    try:
        url = 'https://investors.fennecpharma.com/events-and-presentations/news-releases' 
        ...
        article_desc = FIRST_ARTICLE.find('div', attrs={'class':'views-field views-field-field-nir-news-title'})
        all_a = article_desc.findAll('a')
        article_url = all_a[1]
