...
def main(id_control):
    try:
        url = 'https://www.xoma.com/news/press-releases/' 
        ...
        #print(soup)
        articles_panel = soup.find('ul', attrs={'class':'wpra-item-list rss-aggregator'})
        articles = articles_panel.findAll('li', attrs={'class':'wpra-item feed-item'})
        
        # get first article
        FIRST_ARTICLE = articles[0]

        article_date = FIRST_ARTICLE.find('span', attrs={'class':'feed-date'})
