...
def main(id_control):
    try:
        ...
        #print(soup)
        articles = soup.findAll('li', attrs={'class':'page__news-article-item'})
        
        # get first article
        FIRST_ARTICLE = articles[0]

        article_date = FIRST_ARTICLE.find('p', attrs={'class':'page__news-article__posted-at'})
        article_desc = FIRST_ARTICLE.find('h3', attrs={'class':'page__news-article__title'})
