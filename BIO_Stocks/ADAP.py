...
def main(id_control):
    try:
        url = 'https://www.adaptimmune.com/investors-and-media/news-center/press-releases' 
        req = Request(
            url=url, 
        ...
        articles_panel = soup.find('div', attrs={'class':'main-content has-tertiary-nav'})
        articles = articles_panel.findAll('article', attrs={'class':'media'})
        ...
        date = v_article_date[0:len(v_article_date)-11]
