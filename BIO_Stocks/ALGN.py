...
def main(id_control):
    ...
    try:
        url = 'https://investor.aligntech.com/company-information/news-release' 
        ...
        table = soup.find('table', attrs={'class':'nirtable dataTable'})
        #print(table)
        ...
        v_article_date = FIRST_ROW_columns[0].find('div', attrs={'class':'datetime'}).text.lstrip().rstrip()
        all_a = FIRST_ROW_columns[0].find('a')
        article_desc = all_a
