...
def main(id_control):
    try:
        url = 'https://isrg.intuitive.com/press-releases/' 
        ...
        #print(soup)
        articles = soup.findAll('div', attrs={'class':'row paddingTop34'})
        
        # get first article
        FIRST_ARTICLE = articles[0]

        article_date = FIRST_ARTICLE.find('div', attrs={'class':'newsReleaseDate'})
        article_desc = FIRST_ARTICLE.find('div', attrs={'class':'analystCoverageLabel'})
