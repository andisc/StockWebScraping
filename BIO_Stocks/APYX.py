...
def main(id_control):
    try:
        url = 'https://apyxmedical.com/stockholder-news-2020/' 
        ...
        #print(soup)
        articles = soup.findAll('li', attrs={'class':'post-list-image'})
        
        # get first article
        FIRST_ARTICLE = articles[0]
        

        article_date = FIRST_ARTICLE.find('div', attrs={'class':'post-list-meta'})
        article_desc = FIRST_ARTICLE.find('div', attrs={'class':'post-list-info posts-no-thumb'})
