...
def main(id_control):
    try:
        url = 'https://ir.clearsidebio.com/news-releases' 
        ...
        article_date = FIRST_ARTICLE.find('div', attrs={'class':'newsDate'})
        article_panel = FIRST_ARTICLE.find('div', attrs={'class':'newsTitle'})
