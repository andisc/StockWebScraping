...
def main(id_control):
    try:
        url = 'https://ir.nektar.com/press-releases' 
        ...
        articles = articles_panel.findAll('div', attrs={'id':'ndq-releaseWrap'})
        
        # get first article
        FIRST_ARTICLE = articles[0]

        article_date = FIRST_ARTICLE.find('span', attrs={'class':'ndq-rDate'})
        article_desc = FIRST_ARTICLE.find('div', attrs={'class':'ndq-rTitle'})
