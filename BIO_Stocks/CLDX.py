...
def main(id_control):
    try:
        url = 'https://ir.celldex.com/press-releases' 
        ...
        article_panel = FIRST_ARTICLE.find('div', attrs={'class':'views-field views-field-field-nir-news-title'})
        all_a = article_panel.findAll('a')
