...
def main(id_control):
    ...
    try:
        url = 'https://ir.outlooktherapeutics.com/news-and-events/press-releases/' 
        ...
        table = soup.find('table', attrs={'class':'nirtable collapse-table'})
        #print(table)
        ...
        article_desc = FIRST_ROW_columns[1].find('span', attrs={'class':'nir-widget--field nir-widget--news--headline'})
