...
def main(id_control):
    try:
        url = 'https://www.ceres.org/news-center/press-releases' 
        ...
        #print(soup)
        articles = soup.findAll('a', attrs={'class':'news-wrapper'})
        
        # get first article
        FIRST_ARTICLE = articles[0]

        article_date = FIRST_ARTICLE.find('p', attrs={'class':'news-date'})
        article_desc = FIRST_ARTICLE.find('h3', attrs={'class':'news-title'})
