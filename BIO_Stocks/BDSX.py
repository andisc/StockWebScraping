...
def main(id_control):
    try:
        url = 'https://www.biodesix.com/newsroom/press-releases' 
        ...
        #print(soup)
        articles = soup.findAll('div', attrs={'class':'post-item postnum1'})
        
        # get first article
        FIRST_ARTICLE = articles[0]

        article_date = FIRST_ARTICLE.find('span', attrs={'class':'post-date'})
