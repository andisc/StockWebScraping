...
def main(id_control):
    try:
        url = 'https://ir.surgerypartners.com/news-releases' 
        ...
        #print(soup)
        articles = soup.findAll('article', attrs={'class':'NewsArticle NewsArticle--preview'})
        
        # get first article
        FIRST_ARTICLE = articles[0]

        article_date = FIRST_ARTICLE.find('p', attrs={'class':'NewsArticle-date'})
        article_desc_panel = FIRST_ARTICLE.find('h4')
