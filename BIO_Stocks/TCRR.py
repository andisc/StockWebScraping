...
def main(id_control):
    try:
        url = 'https://investors.tcr2.com/news-releases/' 
        ...
        articles = articles_panel.findAll('div', attrs={'class':'row sqs-row news-row'})
        
        # get first article
        FIRST_ARTICLE = articles[0]

        article_date = FIRST_ARTICLE.find('h3', attrs={'class':'news_date'})
