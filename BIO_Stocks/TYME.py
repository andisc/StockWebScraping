...
def main(id_control):
    try:
        url = 'https://www.tymeinc.com/newsroom/press-releases/default.aspx' 
        ...
        #print(soup)
        articles = soup.findAll('div', attrs={'class':'blog_item'})
        
        # get first article
        FIRST_ARTICLE = articles[0]

        article_date = FIRST_ARTICLE.find('span', attrs={'class':'module_date-time'})
        article_desc = FIRST_ARTICLE.find('h3', attrs={'class':'blog_title'})
