...
def main(id_control):
    try:
        url = 'https://ir.revivapharma.com/news-and-events/press-releases' 
        ...
        article_desc = FIRST_ARTICLE.find('div', attrs={'class':'nir-widget--field nir-widget--news--headline mb-1'})
