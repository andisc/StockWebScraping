...
def main(id_control):
    try:
        url = 'https://ir.lajollapharmaceutical.com/press-releases' 
        ...
        #print(soup)
        articles_panel = soup.find('ul', attrs={'class':'NewsList_articles__3lxcw'})
        articles = articles_panel.findAll('li', attrs={'class':'NewsListItem_article__3FXNv'})
        
        # get first article
        FIRST_ARTICLE = articles[0]

        article_date = FIRST_ARTICLE.find('span', attrs={'class':'NewsListItem_articleDate__36kJq'})
