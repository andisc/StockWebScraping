...
def main(id_control):
    try:
        url = 'https://www.anavex.com/category/news-releases/' 
        ...
        article_date = FIRST_ARTICLE.find('time', attrs={'class':'entry-date updated'})
        article_desc = FIRST_ARTICLE.find('h3', attrs={'class':'entry-title'})
