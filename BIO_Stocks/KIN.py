...
def main(id_control):
    try:
        url = 'https://ir.kindredbio.com/press-releases/' 
        ...
        #print(soup)
        articles_panel = soup.find('div', attrs={'class':'news-long'})
        articles = articles_panel.findAll('div', attrs={'class':'news-list'})
        
        # get first article
        FIRST_ARTICLE = articles[0]

        article_date = FIRST_ARTICLE.find('p', attrs={'class':'news-date'})
        article_desc = FIRST_ARTICLE.find('p', attrs={'class':'news-title'})
