...
def main(id_control):
    try:
        url = 'https://investor.henryschein.com/press-releases' 
        ...
        #print(soup)
        articles = soup.findAll('div', attrs={'class':'idm-col-sm-12 idm-col-md-6 idm-col-lg-3 news-grid-item'})
        
        # get first article
        FIRST_ARTICLE = articles[0]

        article_date = FIRST_ARTICLE.find('div', attrs={'class':'news-grid-date'})
        article_desc = FIRST_ARTICLE.find('div', attrs={'class':'news-grid-title'})
