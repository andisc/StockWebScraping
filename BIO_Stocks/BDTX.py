...
def main(id_control):
    try:
        url = 'https://investors.blackdiamondtherapeutics.com/news-and-events/news-releases/' 
        ...
        article_date_day = FIRST_ARTICLE.find('span', attrs={'class':'press-date'})
        article_date_month = FIRST_ARTICLE.find('span', attrs={'class':'press-year'})
        v_article_date = (article_date_day.text + ' ' + article_date_month.text)
