...
def main(id_control):
    try:
        url = 'https://ir.heska.com/news-releases/' 
        ...
        #print(soup)
        articles_panel = soup.find('ul', attrs={'class':'qmod-news-list'})
        articles = articles_panel.findAll('li')
        
        # get first article
        FIRST_ARTICLE = articles[0]

        article_date = FIRST_ARTICLE.find('span', attrs={'class':'qmod-news-datetime'})
