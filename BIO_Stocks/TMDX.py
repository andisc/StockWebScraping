...
def main(id_control):
    try:
        url = 'https://investors.transmedics.com/news-releases' 
        ...
        article_date = FIRST_ARTICLE.find('time', attrs={'class':'nir-widget--field nir-widget--news--date-time'})
        article_desc = FIRST_ARTICLE.find('p', attrs={'class':'nir-widget--field nir-widget--news--headline'})
