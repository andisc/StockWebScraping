...
def main(id_control):
    try:
        url = 'https://www.aziyo.com/about/news-press/' 
        ...
        article_date = FIRST_ARTICLE.find('p', attrs={'class':'post-meta'})
        article_desc = FIRST_ARTICLE.find('h4', attrs={'class':'entry-title'})
