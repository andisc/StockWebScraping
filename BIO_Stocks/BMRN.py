...
def main(id_control):
    try:
        url = 'https://investors.biomarin.com/press-releases' 
        ...
        #print(soup)
        articles_panel = soup.find('ul', attrs={'class':'wd_layout-simple wd_item_list'})
        ...
        article_desc = FIRST_ARTICLE.find('div', attrs={'class':'wd_pdf_link'})
