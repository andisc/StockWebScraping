...
def main(id_control):
    try:
        ...
        #print(soup)
        articles_table = soup.find('div', attrs={'class':'news-table-body'})
        articles = articles_table.findAll('div', attrs={'class':'row'})
        
        # get first article
        FIRST_ARTICLE = articles[0]

        all_div = FIRST_ARTICLE.findAll('div')

        article_date = all_div[0]
        article_desc = all_div[1]
