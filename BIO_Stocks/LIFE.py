...
def main(id_control):
    try:
        url = 'https://investors.atyrpharma.com/news-releases' 
        ...
        #print(soup)
        articles = soup.findAll('li', attrs={'class':'has-news-supp'})
        
        # get first article
        FIRST_ARTICLE = articles[0]

        article_date = FIRST_ARTICLE.find('div', attrs={'class':'field field--name-field-nir-news-date field--type-datetimezone field--label-above'})
