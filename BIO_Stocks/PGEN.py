...
def main(id_control):
    try:
        url = 'https://investors.precigen.com/pressreleases/' 
        ...
        article_desc = FIRST_ARTICLE.find('div', attrs={'class':'headline'})
        article_url = FIRST_ARTICLE.find('div', attrs={'class':'press-release'})
