...
def main(id_control):
    ...
    try:
        url = 'https://ir.tgtherapeutics.com/press-releases' 
        ...
        table = soup.find('table', attrs={'class':'nirtable collapse-table no-data-before'})
        #print(table)
        ...
        all_a = FIRST_ROW_columns[0].findAll('a')
