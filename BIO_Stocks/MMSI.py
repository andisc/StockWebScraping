...
def main(id_control):
    try:
        url = 'https://www.merit.com/investors/press-releases/' 
        ...
        #print(soup)
        articles_panel = soup.find('div', attrs={'class':'avia_textblock'})
        articles = articles_panel.findAll('p')
        
        # get first article
        FIRST_ARTICLE = articles[0]

        article_date = FIRST_ARTICLE.find('span', attrs={'class':'small'})
