...
def main(id_control):
    try:
        url = 'http://ir.nextcure.com/news-releases/' 
        ...
        articles = articles_panel.findAll('div', attrs={'class':'news-entry'})
        
        # get first article
        FIRST_ARTICLE = articles[0]
        
        article_detail = FIRST_ARTICLE.find('div', attrs={'class':'top-line'})
        article_date = FIRST_ARTICLE.find('p')
        article_desc = FIRST_ARTICLE.find('p')
