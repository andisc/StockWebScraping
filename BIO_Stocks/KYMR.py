...
def main(id_control):
    try:
        url = 'https://investors.kymeratx.com/press-releases' 
        ...
        article_date = FIRST_ARTICLE.find('div', attrs={'class':'listing__item__date'})
        article_desc = FIRST_ARTICLE.find('div', attrs={'class':'listing__item__name'})
