...
def main(id_control):
    ...
    try:
        url = 'https://seelostherapeutics.com/press-releases-2/' 
        ...
        table = soup.find('table', attrs={'class':'b2iPlugInHeadLineTable'})
        #print(table)
        ...
        SECOND_ROW_columns = rows[1].find_all('td')
        v_article_date = FIRST_ROW_columns[0].text.lstrip().rstrip()
        article_desc = SECOND_ROW_columns[0]
