...
def main(id_control):
    try:
        url = 'https://investors.csi360.com/news-releases/default.aspx' 
        ...
        #print(soup)
        articles = soup.findAll('div', attrs={'class':'module_item clearfix'})
        
        # get first article
        FIRST_ARTICLE = articles[0]

        article_date = FIRST_ARTICLE.find('div', attrs={'class':'module_date-time'})
        article_desc = FIRST_ARTICLE.find('div', attrs={'class':'module_headline clearfix'})
