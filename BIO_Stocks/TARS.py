...
def main(id_control):
    try:
        url = 'https://ir.tarsusrx.com/news-events' 
        ...
        articles = articles_panel.findAll('div', attrs={'class':'news-grid-inner'})
        
        # get first article
        FIRST_ARTICLE = articles[0]

        article_date = FIRST_ARTICLE.find('div', attrs={'class':'news-grid-date'})
        article_desc = FIRST_ARTICLE.find('div', attrs={'class':'idm-mb-2 news-grid-ttl'})
