...
def main(id_control):
    ...
    try:
        url = 'https://heliusmedical.com/index.php/newsroom/news-release/2020' 
        ...
        table = soup.find('table', attrs={'class':'category table table-striped table-bordered table-hover'})
        #print(table)
        ...
        v_article_date = FIRST_ROW_columns[1].text.lstrip().rstrip()
        article_desc = FIRST_ROW_columns[0]
