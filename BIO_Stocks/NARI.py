...
def main(id_control):
    try:
        url = 'https://ir.inarimedical.com/news-events/press-releases/' 
        ...
        articles = articles_panel.findAll('div', attrs={'class':'news-item'})
        
        # get first article
        FIRST_ARTICLE = articles[0]

        article_date = FIRST_ARTICLE.find('p', attrs={'class':'news-date'})
        article_desc = FIRST_ARTICLE.find('h2', attrs={'class':'news-title'})
