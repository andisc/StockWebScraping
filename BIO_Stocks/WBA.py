...
def main(id_control):
    try:
        url = 'https://www.walgreensbootsalliance.com/news-media/press-releases' 
        ...
        #print(soup)
        articles_panel = soup.find('ul', attrs={'class':'component-featured-content__list'})
        ...
        article_desc = FIRST_ARTICLE.find('header', attrs={'class':'node__title'})
