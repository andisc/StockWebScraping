...
def main(id_control):
    try:
        url = 'https://investor.agios.com/news-releases/' 
        ...
        #print(soup)
        articles_all = soup.findAll('div', attrs={'class':'item-list'})
        
        articles = soup.findAll('div', attrs={'class':'col'})
        
        # get first article
        FIRST_ARTICLE = articles[0]

        article_date = FIRST_ARTICLE.find('div', attrs={'class':'field__item'})
