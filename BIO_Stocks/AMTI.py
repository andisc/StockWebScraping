...
def main(id_control):
    try:
        url = 'https://ir.appliedmt.com/news-events/press-releases/' 
        ...
        #print(soup)
        articles = soup.findAll('div', attrs={'class':'pub-row none'})
        
        # get first article
        FIRST_ARTICLE = articles[0]

        article_date = FIRST_ARTICLE.find('div', attrs={'class':'nir-widget--news--date-time'})
        article_desc = FIRST_ARTICLE.find('h2', attrs={'class':'pub-title nir-widget--news--headline mt-0'})
