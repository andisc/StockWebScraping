...
def main(id_control):
    try:
        url = 'https://savarapharma.com/investors/press-releases/' 
        ...
        #print(soup)
        articles = soup.findAll('div', attrs={'class':'feed-wrap'})
        
        # get first article
        FIRST_ARTICLE = articles[0]

        article_date = FIRST_ARTICLE.find('div', attrs={'class':'rss-date'})
        article_desc = FIRST_ARTICLE.find('div', attrs={'class':'rss-title'})
