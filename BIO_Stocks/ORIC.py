...
def main(id_control):
    try:
        url = 'https://investors.oricpharma.com/news-releases/' 
        ...
        #print(soup)
        articles = soup.findAll('div', attrs={'class':'item-3 fl-container xs-fl-col'})
        
        # get first article
        FIRST_ARTICLE = articles[0]

        article_date = FIRST_ARTICLE.find('div', attrs={'class':'date-col'})
        article_desc = FIRST_ARTICLE.find('div', attrs={'class':'text-col'})
