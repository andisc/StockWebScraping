...
def main(id_control):
    try:
        url = 'https://ir.avidbio.com/news-releases' 
        ...
        #print(soup)
        articles = soup.findAll('a', attrs={'class':'newslist__news'})
        
        # get first article
        FIRST_ARTICLE = articles[0]

        article_date = FIRST_ARTICLE.find('div', attrs={'class':'newslist__date'})
        article_desc = FIRST_ARTICLE.find('div', attrs={'class':'newslist__name'})
