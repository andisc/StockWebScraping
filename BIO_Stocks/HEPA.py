...
def main(id_control):
    try:
        url = 'https://hepionpharma.com/investors/news/' 
        ...
        #print(soup)
        articles_panel = soup.find('div', attrs={'class':'wpb_raw_code wpb_content_element wpb_raw_html'})
        all_a = articles_panel.findAll('a')
        all_date = articles_panel.findAll('span', attrs={'class':'small'})
        
        
        # get first article
        #FIRST_ARTICLE = articles[0]

        article_date = all_date[0]
