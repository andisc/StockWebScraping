...
def main(id_control):
    try:
        url = 'https://regenxbio.gcs-web.com/press-releases/' 
        ...
        #print(soup)
        articles = soup.findAll('div', attrs={'class':'tg-item-content-holder tg-dark standard-format'})
        
        # get first article
        FIRST_ARTICLE = articles[0]

        article_date = FIRST_ARTICLE.find('span', attrs={'class':'tg-item-date'})
        article_desc = FIRST_ARTICLE.find('div', attrs={'class':'tg-item-title'})
