...
def main(id_control):
    try:
        url = 'https://investors.deciphera.com/news-events/press-releases' 
        ...
        article_date = FIRST_ARTICLE.find('div', attrs={'class':'press_date'})
        article_desc = FIRST_ARTICLE.find('div', attrs={'class':'nir-widget--field nir-widget--news--headline press_title_cont'})
