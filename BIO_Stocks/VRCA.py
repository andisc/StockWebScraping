...
def main(id_control):
    try:
        url = 'https://verrica.com/press-releases/' 
        ...
        articles = soup.findAll('li', attrs={'class':'dce-views-render-list dce-view-list-element   dce-view-element dce-view-element-5771 dce-view-single-wrapper dce-view-single'})
        
        # get first article
        FIRST_ARTICLE = articles[0]

        article_date = FIRST_ARTICLE.find('div', attrs={'class':'elementor-heading-title elementor-size-default'})
        article_desc = FIRST_ARTICLE.find('h6', attrs={'class':'elementor-heading-title elementor-size-default'})
