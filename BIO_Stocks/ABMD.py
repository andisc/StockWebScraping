...
def main(id_control):
    ...
    try:
        url = 'https://investors.abiomed.com/events-presentations' 
        ...
        date = FIRST_ROW_columns[0].find('span', attrs={'class':'event'})
        v_article_date = date.text.lstrip().rstrip()
        article_desc = FIRST_ROW_columns[1].find('div', attrs={'class':'nir-events-widget-event-details-title'})
