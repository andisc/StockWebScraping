...
def main(id_control):
    try:
        url = 'https://myriad.com/investors/news-release/' 
        ...
        #print(soup)
        articles_panel = soup.find('div', attrs={'class':'nrwrap'})
        articles = articles_panel.findAll('div', attrs={'class':'row'})
        
        # get first article
        FIRST_ARTICLE = articles[0]
        
        all_divs = FIRST_ARTICLE.findAll('div')
        article_date = all_divs[0]
        article_desc = all_divs[1]
