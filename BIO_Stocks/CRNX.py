...
def main(id_control):
    try:
        url = 'https://crinetics.com/press-releases/' 
        ...
        #print(soup)
        articles = soup.findAll('div', attrs={'class':'t-entry'})
        
        # get first article
        FIRST_ARTICLE = articles[0]

        article_date = FIRST_ARTICLE.find('p', attrs={'class':'t-entry-meta'})
        article_desc = FIRST_ARTICLE.find('h2', attrs={'class':'t-entry-title h3'})
