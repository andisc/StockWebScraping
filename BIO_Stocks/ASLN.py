...
def main(id_control):
    ...
    try:
        ...
        #print(soup)
        article = soup.find('article', attrs={'class':'news-article'})
        
        article_date = article.find('span', attrs={'class':'date'})
        article_desc = soup.find('h3', attrs={'class':'news-article-title'})
