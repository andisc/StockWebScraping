...
def main(id_control):
    try:
        url = 'https://www.neogen.com/neocenter/press-releases/' 
        ...
        #print(soup)
        articles = soup.findAll('div', attrs={'class':'neo-center-preview__body'})
        
        # get first article
        FIRST_ARTICLE = articles[0]

        article_date = FIRST_ARTICLE.find('div', attrs={'class':'neo-center-preview__date'})
