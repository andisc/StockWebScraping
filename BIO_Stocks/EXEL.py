...
def main(id_control):
    try:
        url = 'https://ir.exelixis.com/press-releases' 
        ...
        article_date = FIRST_ARTICLE.find('div', attrs={'class':'ccbnResponsiveCell ccbnResponsive20'})
        article_desc = FIRST_ARTICLE.find('div', attrs={'class':'ccbnResponsiveCell ccbnResponsive70'})
