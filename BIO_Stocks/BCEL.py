...
def main(id_control):
    try:
        url = 'https://ir.atreca.com/news-and-events/news-releases/' 
        ...
        #print(soup)
        articles = soup.findAll('div', attrs={'class':'press element-item current thumbnail-default'})
        
        # get first article
        FIRST_ARTICLE = articles[0]

        article_date = FIRST_ARTICLE.find('span')
