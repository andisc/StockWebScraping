...
def main(id_control):
    try:
        url = 'http://investors.salariuspharma.com/news-releases' 
        ...
        article_date = FIRST_ARTICLE.find('div', attrs={'class':'date smallHeading underLineHeading darkBlueColor'})
        article_desc = FIRST_ARTICLE.find('h2')
        article_url = FIRST_ARTICLE.find('a')
