...
def main(id_control):
    try:
        url = 'https://investor.incyte.com/press-releases' 
        ...
        article_date = FIRST_ARTICLE.find('div', attrs={'class':'module_date-text'})
        article_desc = FIRST_ARTICLE.find('div', attrs={'class':'module_headline grid_col'})
