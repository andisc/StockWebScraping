...
def main(id_control):
    try:
        url = 'https://www.royaltypharma.com/investors/news-and-events/press-releases/' 
        ...
        article_date = FIRST_ARTICLE.find('div', attrs={'class':'article_meta'})
        article_desc = FIRST_ARTICLE.find('h3', attrs={'class':'article_title'})
