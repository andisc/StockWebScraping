...
def main(id_control):
    try:
        url = 'https://www.inotivco.com/about/news/' 
        ...
        #print(soup)
        articles = soup.findAll('div', attrs={'class':'card financial-news'})
        
        # get first article
        FIRST_ARTICLE = articles[0]
        print(FIRST_ARTICLE)

        article_date = FIRST_ARTICLE.find('p', attrs={'class':'card-meta-date'})
        article_desc = FIRST_ARTICLE.find('h3', attrs={'class':'card-title'})
