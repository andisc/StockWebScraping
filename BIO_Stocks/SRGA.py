...
def main(id_control):
    try:
        url = 'https://www.surgalign.com/investors/newsroom/' 
        ...
        #print(soup)
        articles_panel = soup.find('div', attrs={'class':'o-grid o-grid--equal-height'})
        articles = articles_panel.findAll('article')
        
        # get first article
        FIRST_ARTICLE = articles[0]

        article_date = FIRST_ARTICLE.find('div', attrs={'class':'c-type c-type--tophat u-color-blue-base'})
