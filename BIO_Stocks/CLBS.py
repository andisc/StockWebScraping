...
def main(id_control):
    try:
        ...
        #print(soup)
        articles = soup.findAll('div', attrs={'class':'newsevent_post_wrapper'})
        
        # get first article
        FIRST_ARTICLE = articles[0]

        article_date = FIRST_ARTICLE.find('p', attrs={'class':'newsevent_date'})
        article_desc = FIRST_ARTICLE.find('h4', attrs={'class':'newsevent_post_title'})
