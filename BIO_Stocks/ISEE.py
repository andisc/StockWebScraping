...
def main(id_control):
    try:
        url = 'https://investors.ivericbio.com/press-releases' 
        ...
        articles = articles_panel.findAll('div', attrs={'class':'ir-box'})
        
        # get first article
        FIRST_ARTICLE = articles[0]

        article_date = FIRST_ARTICLE.find('div', attrs={'class':'ir-date'})
        article_desc = FIRST_ARTICLE.find('div', attrs={'class':'ir-title'})
