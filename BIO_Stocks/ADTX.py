...
def main(id_control):
    try:
        url = 'https://aditxt.com/investor-relations/press-releases/' 
        ...
        #print(soup)
        articles_all = soup.find('div', attrs={'class':'qmod-news-output'})
        print(articles_all)
        articles = articles_all.findAll('ul', attrs={'class':'qmod-news-list'})
        print(articles)
        
        # get first article
        FIRST_ARTICLE = articles[0]

        article_date = FIRST_ARTICLE.find('p', attrs={'class':'date-time'})
