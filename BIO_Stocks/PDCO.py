...
def main(id_control):
    try:
        url = 'https://investor.pattersoncompanies.com/investor-relations/press-releases/default.aspx' 
        ...
        #print(soup)
        articles_panel = soup.find('div', attrs={'class':'module_container module_container--content module_container--content-press'})
        articles = articles_panel.findAll('div', attrs={'class':'module_item'})
        
        # get first article
        FIRST_ARTICLE = articles[0]

        article_date = FIRST_ARTICLE.find('span', attrs={'class':'module_date-text'})
        article_desc = FIRST_ARTICLE
