...
def main(id_control):
    try:
        url = 'https://ir.alpineimmunesciences.com/newsreleases' 
        ...
        articles = soup.findAll('div', attrs={'class':'has-news-supp'})
        ...
        article_desc_panel = FIRST_ARTICLE.find('div', attrs={'class':'field-content'})
