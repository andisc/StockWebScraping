...
def main(id_control):
    try:
        url = 'https://ir.clovisoncology.com/investors-and-news/news-releases/default.aspx' 
        ...
        article_url_all = article_desc.findAll('a')
        ...
        if (istoday == True):
            ...
            v_description = article_url.text.lstrip().rstrip()
            now = datetime.now()
