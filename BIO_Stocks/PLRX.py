...
def main(id_control):
    ...
    try:
        url = 'https://ir.pliantrx.com/news-and-events/press-releases/' 
        ...
        table = soup.find('table', attrs={'class':'collapse-table wsh-releases wsh-dataTable jq-headers nirtable'})
        #print(table)
