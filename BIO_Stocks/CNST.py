...
def main(id_control):
    try:
        url = 'https://ir.constellationpharma.com/news-releases' 
        ...
        #print(soup)
        articles = soup.findAll('div', attrs={'class':'row news-row'})
        
        # get first article
        FIRST_ARTICLE = articles[0]

        article_date = FIRST_ARTICLE.find('div', attrs={'class':'col-md-2 news-date'})
        article_desc = FIRST_ARTICLE.find('div', attrs={'class':'col-md-9 news-title'})
