...
def main(id_control):
    try:
        url = 'https://www.ufpt.com/investors/press-releases.html' 
        ...
        #print(soup)
        articles_panel = soup.find('div', attrs={'class':'newsPage'})
        articles = articles_panel.findAll('div', attrs={'class':'newsRow'})
        
        # get first article
        FIRST_ARTICLE = articles[0]

        article_date = FIRST_ARTICLE.find('div', attrs={'class':'date'})
        article_desc = FIRST_ARTICLE.find('div', attrs={'class':'title'})
