...
def main(id_control):
    try:
        url = 'https://www.halo.com/press-releases.aspx' 
        ...
        #print(soup)
        articles_panel = soup.find('div', attrs={'class':'StaticContent'})
        
        all_dt = articles_panel.findAll('dt')
        all_dd = articles_panel.findAll('dd')
        
        # get first article
        #FIRST_ARTICLE = articles[0]

        article_date = all_dt[0]
        article_desc = all_dd[0]
