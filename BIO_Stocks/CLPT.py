...
def main(id_control):
    try:
        url = 'https://ir.stockpr.com/clearpointneuro/press-releases' 
        ...
        #print(soup)
        articles_panel = soup.find('div', attrs={'class':'spr-ir-news rss-news'})
        articles = articles_panel.findAll('li', attrs={'class':'rss-item'})
        
        # get first article
        FIRST_ARTICLE = articles[0]

        article_date = FIRST_ARTICLE.find('span', attrs={'class':'spr-ir-news-date'})
