...
def main(id_control):
    try:
        url = 'https://immunitybio.com/category/press-releases/' 
        ...
        #print(soup)
        articles_panel = soup.find('div', attrs={'id':'left-area'})
        articles = articles_panel.findAll('article')
        
        # get first article
        FIRST_ARTICLE = articles[0]

        article_date = FIRST_ARTICLE.find('span', attrs={'class':'published'})
        article_desc = FIRST_ARTICLE.find('h2', attrs={'class':'entry-title'})
