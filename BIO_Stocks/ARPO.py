...
def main(id_control):
    try:
        ...
        #print(soup)
        articles = soup.findAll('div', attrs={'class':'axxiem-event-list'})
        
        # get first article
        FIRST_ARTICLE = articles[0]
        

        article_date = FIRST_ARTICLE.find('p', attrs={'class':'axxiem-event-startDate'})
        article_desc = FIRST_ARTICLE.find('h3', attrs={'class':'axxiem-event-title'})
