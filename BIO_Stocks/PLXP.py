...
def main(id_control):
    ...
    try:
        url = 'https://ir.plxpharma.com/news-releases' 
        ...
        table = soup.find('table', attrs={'class':'dataTable nirtable tbl-content collapse-table nirtable news-long'})
        #print(table)
        ...
        article_desc_panel = FIRST_ROW_columns[1].find('div', attrs={'class':'views-field views-field-field-nir-news-title'})
