...
def main(id_control):
    try:
        url = 'https://kiromic.com/news/press-releases/' 
        ...
        #print(soup)
        articles_panel = soup.find('div', attrs={'class':'posts-w-dates'})
        articles_small = articles_panel.findAll('small', attrs={'class':'date'})
        articles_h3 = articles_panel.findAll('h3')
        
        # get first article
        #FIRST_ARTICLE = articles[0]

        article_date = articles_small[0]
        article_desc = articles_h3[0]
